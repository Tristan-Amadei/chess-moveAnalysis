...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.label_1.grid(row=1, column=1, pady=10, padx=1)

        self.button_1 = customtkinter.CTkButton(master=self.frame_left,
                                                text="Avancer d'un coup",
                                                command=self.button_event)
        self.button_1.grid(row=2, column=2, pady=10, padx=2)

        self.button_6 = customtkinter.CTkButton(master=self.frame_left,
                                                text="Coup par coup",
                                                command=self.button_event)
        self.button_6.grid(row=2, column=1, pady=10, padx=2)

        self.button_2 = customtkinter.CTkButton(master=self.frame_left,
                                                text="Revenir d'un coup",
                                                command=self.button_event)
        self.button_2.grid(row=2, column=0, pady=10, padx=2)

        self.button_3 = customtkinter.CTkButton(master=self.frame_left,
                                                text="Mettre la pause",
                                                command=self.button_event)
        self.button_3.grid(row=3, column=1, pady=10, padx=2)

        self.button_4 = customtkinter.CTkButton(master=self.frame_left,
                                                text="Mettre la pause",
                                                command=self.button_event)
        self.button_4.grid(row=3, column=0, pady=10, padx=2)

        self.button_5 = customtkinter.CTkButton(master=self.frame_left,
                                                text="Accélérer",
                                                command=self.button_event)
        self.button_5.grid(row=3, column=2, pady=10, padx=2)
        ...
        self.label_mode.grid(row=9, column=0, pady=0, padx=2, sticky="w")

        self.optionmenu_1 = customtkinter.CTkOptionMenu(master=self.frame_left,
                                                        values=["Light", "Dark", "System"],
                                                        command=self.change_appearance_mode)
        self.optionmenu_1.grid(row=10, column=0, pady=10, padx=2, sticky="w")
        ...
        image = Image.open("Chess_image.png").resize((self.WIDTH-600, self.HEIGHT-300))
        self.bg_image = ImageTk.PhotoImage(image)

        self.image_label = tkinter.Label(master=self.frame_info, image=self.bg_image,
                                                   height=800,
                                                    width=600)
        self.image_label.grid(row=1, column=0, sticky="ew", padx=15, pady=15)
